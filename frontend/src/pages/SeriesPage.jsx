...
function SeriesPage() {
  ...
  const fetchSeries = useCallback(async () => {
    try {
      ...
      if (!token) {
        console.error('[Series] No token found, redirecting to login');
      ...
      console.log('[Series] Fetching M3U from:', fetchUrl);
      console.log('[Series] User M3U URL:', user.m3uUrl ? 'defined' : 'undefined');
